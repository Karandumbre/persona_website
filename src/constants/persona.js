export const PERSONA = {
  SOCIAL: [
    {
      name: "instagram",
      url: "https://www.instagram.com/personastudio60/",
      className: "fa fa-instagram",
    },
  ],
  MAIN: {
    name: "Persona: Image Editor",
    description: "Create Impressions",
    image: "profilepic.png",
    bio: "Persona photo editor is a powerful photo editing application for photography and it contains vast editing options for retouching your photos. Make your picture-perfect using a wide range of amazing effects, filters, overlays and color edit tools, and many more features.",
    contactmessage:
  ...
  RESUME: {
    PRIVACY_POLICIES: [
      ...
      {
        company: "Information Collection and Use",
        description: [
      ...
      },
      {
        company: "Security",
        description: [
          "I value your trust in providing us your Personal Information, thus we are striving to use commercially acceptable means of protecting it. But remember that no method of transmission over the internet, or method of electronic storage is 100% secure and reliable, and I cannot guarantee its absolute secu ",
        ],
      },
      {
        company: "Links to Other Sites",
        description: [
          "This Service may contain links to other sites. If you click on a third-party link, you will be directed to that site. Note that these external sites are not operated by me. Therefore, I strongly advise you to review the Privacy Policy of these websites. I have no control over and assume no responsibility for the content, privacy policies, or practices of any third-party sites or services.",
        ],
      },
      {
        company: "Children’s Privacy",
        description: [
          "These Services do not address anyone under the age of 13. I do not knowingly collect personally identifiable information from children under 13. In the case I discover that a child under 13 has provided me with personal information, I immediately delete this from our servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact me so that I will be able to do necessary actions.",
        ],
      },
      {
        company: "Changes to This Privacy Policy",
        description: [
    ...
    SKILLS: [
      {
        description: [
          ...
          "The app does any third party services that declare their own Terms and Conditions.",
      ...
      },
      {
        company: "Contact Us",
        description: [
          " If you have any questions or suggestions about my Privacy Policies and Terms and Conditions, do not hesitate to contact me at karandumbre1@gmail.com.",
        ],
      },
    ],
  },
  TESTIMONIALS: [
    {
      user: "John Doe",
      text: "This app is absolutely amazing! It has transformed the way I edit my photos.",
    },
    {
      user: "Jane Smith",
      text: "I've tried many photo editors, but Persona stands out with its user-friendly interface and powerful features.",
    },
    {
      user: "Mike Johnson",
      text: "Highly recommend Persona for anyone looking to enhance their photos effortlessly!",
    },
    {
      user: "Emily Davis",
      text: "The filters and effects available in Persona are top-notch. It's my go-to app for photo editing.",
    },
    {
      user: "David Brown",
      text: "Persona has everything I need to make my photos look professional. Five stars!",
    },
  ],
};
